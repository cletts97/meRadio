...
def load_simple_descriptions(filename, dataset):
	# load document
	doc = load_doc(filename)
	descriptions = dict()
	for line in doc.split('\n'):
...
# descriptions
train_descriptions = load_simple_descriptions('descriptions.txt', train)
...
# descriptions
test_descriptions = load_simple_descriptions('descriptions.txt', test)
